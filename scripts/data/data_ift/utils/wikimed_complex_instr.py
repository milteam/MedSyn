...
def generate_data(
    ...
    os.makedirs(results_dir, exist_ok=True)
    generate_data_for_type(
        wikimed_drugs_path,
        results_dir,
        result_name="drugs.jsonl",
        questions=QUESTIONS_DRUG,
        max_tokens_thresh=max_tokens_thresh,
    )
    generate_data_for_type(
        wikimed_dis_path,
        results_dir,
        result_name="diseases.jsonl",
        questions=QUESTIONS_DIS,
        max_tokens_thresh=max_tokens_thresh,
    )
