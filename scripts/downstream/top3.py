...
from scripts.downstream.top3_model.sentence_bert import train_sentence_transformers
...
@click.option('--model', '-m', type=click.Choice(['st', 'hf']),
              help="st - sentence transformer, hf - huggingface model for sequence classication", required = True)
