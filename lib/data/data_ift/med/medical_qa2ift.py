...
INSTRUCTIONS = [
    ...
    "Предоставь ответ с точки зрения медицинского специалиста",
    "Ответь как профессиональный врач",
    "Дай профессиональную медицинскую рекомендацию",
    "Используй свои знания врача для ответа на этот вопрос",
    "Предложи решение, основываясь на медицинской практике",
    "Как врач, дай своё мнение по этому вопросу",
    "Оказывая врачебную помощь, ответь на вопрос",
]
