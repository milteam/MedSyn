"""Convert Almazov anamnesis data to IFT data format."""
...
@click.command()
@click.option("--results-dir", default="data/data_ift/almazov")
@click.option("--result-name", default="almazov_data_ift.json")
@click.option("--samples-path", default="data/data_raw/almazov.csv")
